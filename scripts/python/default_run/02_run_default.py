...
# -*- coding: utf-8 -*-
"""
Execute model run with default FATES parameters.
"""
...
# Configure logger
logger = setup_logging('default-run')


def main() -> None:

    # File name stem of parameter ensemble (pkl, csv, json)
    file_stem_name = 'HYY_default_run'
    ...
    run_subprocess(
        cmd=[
            f"python3 create_single_case.py -f {file_stem_name}.json"
        ],
